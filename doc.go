...
The simplest way to convert a markdown document to HTML:
...
You can customize the parser and HTML renderer:
...
For a command-line tool see https://github.com/gomarkdown/mdtohtml
*/
package markdown
